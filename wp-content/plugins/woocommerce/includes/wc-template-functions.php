...
function wc_get_product_class($class = '', $product = null)
{
  ...
  $classes = array_merge(
    ...
    $product->get_stock_status(),
      ), wc_get_product_taxonomy_class($product->get_category_ids(), 'product_cat'), wc_get_product_taxonomy_class($product->get_tag_ids(), 'product_tag')
  );
...
function wc_get_gallery_image_html($attachment_id, $main_image = false)
{
  ...
  $thumbnail_size = apply_filters('woocommerce_gallery_thumbnail_size', array($gallery_thumbnail['width'],
...
if (!function_exists('woocommerce_grouped_add_to_cart')) {
  ...
  function woocommerce_grouped_add_to_cart()
  {
    ...
    if ($products) {
      wc_get_template(
          'single-product/add-to-cart/grouped.php', array(
...
if (!function_exists('woocommerce_external_add_to_cart')) {
  ...
  function woocommerce_external_add_to_cart()
  {
    ...
    wc_get_template(
        'single-product/add-to-cart/external.php', array(
...
if (!function_exists('woocommerce_quantity_input')) {
  ...
  function woocommerce_quantity_input($args = array(), $product = null, $echo = true)
  {
    ...
    $defaults = array(
      ...
      'input_name' => 'quantity',
      'input_value' => '1',
      'classes' => apply_filters('woocommerce_quantity_input_classes', array('input-text',
        'qty', 'text'), $product),
...
if (!function_exists('woocommerce_comments')) {
  ...
  function woocommerce_comments($comment, $args, $depth)
  {
    ...
    wc_get_template(
        'single-product/review.php', array(
      'comment' => $comment,
      'args' => $args,
      'depth' => $depth,
        )
...
if (!function_exists('woocommerce_upsell_display')) {
  ...
  function woocommerce_upsell_display($limit = '-1', $columns = 4, $orderby = 'rand', $order = 'desc')
  {
    ...
    wc_get_template(
        'single-product/up-sells.php', array(
      'upsells' => $upsells,
...
if (!function_exists('woocommerce_shipping_calculator')) {
  ...
  function woocommerce_shipping_calculator($button_text = '')
  {
    ...
    wc_get_template(
        'cart/shipping-calculator.php', array(
...
if (!function_exists('woocommerce_order_review')) {
  ...
  {
    wc_get_template(
        'checkout/review-order.php', array(
      'checkout' => WC()->checkout(),
        )
    );
  }
...
if (!function_exists('woocommerce_checkout_coupon_form')) {
  ...
  {
    wc_get_template(
        'checkout/form-coupon.php', array(
      'checkout' => WC()->checkout(),
        )
    );
  }
...
if (!function_exists('woocommerce_get_loop_display_mode')) {
  ...
  function woocommerce_get_loop_display_mode()
  {
    ...
    // Ensure valid value.
    if ('' === $display_type || !in_array($display_type, array('products', 'subcategories',
          'both'), true)) {
  ...
  function woocommerce_get_product_subcategories($parent_id = 0)
  {
    ...
    if (false === $product_categories) {
      ...
      $product_categories = get_categories(
          apply_filters(
              'woocommerce_product_subcategories_args', array(
        'parent' => $parent_id,
        'hide_empty' => 0,
        'hierarchical' => 1,
...
if (!function_exists('woocommerce_order_again_button')) {
  ...
  {
    if (!$order || !$order->has_status(apply_filters('woocommerce_valid_order_statuses_for_order_again', array(
          'completed'))) || !is_user_logged_in()) {
      return;
    }

    wc_get_template(
        'order/order-again.php', array(
      'order' => $order,
...
if (!function_exists('wc_dropdown_variation_attribute_options')) {
  ...
  {
    $args = wp_parse_args(
        apply_filters('woocommerce_dropdown_variation_attribute_options_args', $args), array(
      'options' => false,
      'attribute' => false,
      'product' => false,
      'selected' => false,
  ...
  function wc_get_email_order_items($order, $args = array())
  {
    ...
    wc_get_template(
        $template, apply_filters(
            'woocommerce_email_order_items_args', array(
      'order' => $order,
...
function wc_display_product_attributes($product)
{
  ...
  wc_get_template(
      'single-product/product-attributes.php', array(
